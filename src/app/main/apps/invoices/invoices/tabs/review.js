...
import {
  getReviewInvoices,
  selectReviewInvoices,
} from "../../store/reviewInvoiceSlice";
...
function ReviewTable(props) {
  ...
  const invoices = useSelector(selectReviewInvoices);
  const searchText = useSelector(
    ({ invoicesApp }) => invoicesApp.reviewInvoices.searchText
  );
  ...
  useEffect(() => {
    dispatch(getReviewInvoices()).then(() => setLoading(false));
  }, [dispatch]);
