...
} from "../../store/rejectedInvoiceSlice";
...
function RejectedTable(props) {
  ...
  const invoices = useSelector(selectRejectedInvoices);
  const searchText = useSelector(
    ({ invoicesApp }) => invoicesApp.rejectedInvoices.searchText
  );
  ...
  useEffect(() => {
    dispatch(getRejectedInvoices()).then(() => setLoading(false));
  }, [dispatch]);
...
export default withRouter(RejectedTable);
